    ...
    <div>
      <Grid container spacing={1}>
        ...
        <Grid item xs={2}>
          ...
          <Card>
            <CardContent>
              Tower Sprint is a 4 person race to the bottom game with a low-poly fun aesthetic. 4
              people start at the top of a procedurally generated tower and must race to get to the
              bottom of the tower. There are a variety of randomly placed tools to assist the player
              as well as slow down other players. Some examples include traps to disable players,
              rope ladders to speed descent on the outside of the tower, melee weapons, armor, and
              sledgehammers (for breaking through blockades).
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={6}>
